      ...
      {items.map((item) => {
        ...
        return (
          <a
            ...
            className="social-flip-card group block h-22 rounded-[1.35rem] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]/40 sm:h-24 sm:rounded-[1.6rem]"
          >
